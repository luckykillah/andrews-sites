...
//			unset($options['name']);
			...
			/* CHUNK HIDDEN in favor of CMLL chunck below
			...
			// CMLL ADDED BLOCK -- from http://shibashake.com/wordpress-theme/custom-post-type-permalinks-part-2
			global $wp_rewrite;
			$options['with_front'] = false;
			$training_log_structure = '/training-log/%training-log%';
			$wp_rewrite->add_rewrite_tag("%training-log%", '([^/]+)', "training-log=");
			$wp_rewrite->add_permastruct('training-log', $training_log_structure, false);
